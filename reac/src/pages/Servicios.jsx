...
import { FaCalendarAlt, FaChalkboardTeacher, FaChild, FaUserGraduate } from 'react-icons/fa';
import '../pages/styles/Servicios.css';

function Servicios() {
  return (
    <div className="matricula-container">
      <h1 className="matricula-title"><FaCalendarAlt style={{marginRight: '10px'}}/>Calendario de Matrícula</h1>
      
      <div className="calendar-section">
        <div className="calendar-legend">
          <h3>Leyenda:</h3>
          <ul>
            <li><span className="legend-color inicio"></span> <b>Inicio</b> de clases</li>
            <li><span className="legend-color fin"></span> <b>Fin</b> de clases</li>
          </ul>
        </div>
      ...
      <div className="niveles-educativos">
        ...
        <div className="niveles-cards">
          <div className="nivel-card inicial">
            <FaChild className="nivel-icon" />
            <span>Educación Inicial</span>
          </div>
          <div className="nivel-card primaria">
            <FaChalkboardTeacher className="nivel-icon" />
            <span>Primaria</span>
          </div>
          <div className="nivel-card secundaria">
            <FaUserGraduate className="nivel-icon" />
